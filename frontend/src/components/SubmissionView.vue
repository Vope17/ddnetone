    ...
    <div class="w-full max-w-lg bg-[#0a0a0a] border border-cyan-500/30 p-8 relative overflow-visible group">
      ...
      <form @submit.prevent="submitForm" class="space-y-6">
        ...
        <div class="space-y-2 relative">
          ...
          <div class="relative">
            <input 
              ...
              @input="form.map_name = searchQuery" 
            ...
            <button type="button" @click="showDropdown = !showDropdown" class="absolute right-2 top-3 text-gray-500 hover:text-white">
          ...
          <div v-if="showDropdown" 
            ...
            <div v-for="map in filteredOptions" :key="map.id"
              @click="selectMap(map)"
              ...
              <span v-if="map.points || map.score" class="text-xs bg-gray-800 px-2 py-1 rounded text-gray-400 font-mono group-hover:text-cyan-300">
        ...
        <button type="submit" :disabled="status === 'submitting'"
          :class="['w-full py-4 font-mono font-bold tracking-widest flex items-center justify-center gap-2 transition-all duration-300',
